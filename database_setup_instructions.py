"""
Manual Database Setup Instructions for Supabase
Run this to get the exact SQL commands needed for your database
"""
...
AND (table_name LIKE '%template%' OR table_name LIKE '%certificate%')
ORDER BY table_name;
"""
    ...
    print()
    print("INSTRUCTIONS:")
    print("1. Go to: https://supabase.com/dashboard/project/lpvzcfvcfckgdeuhzhrj")
    print("2. Click 'SQL Editor' in the left sidebar")
    print("3. Click 'New Query'")
    print("4. Copy and paste the SQL above")
    print("5. Click 'Run'")
    print("6. Verify you see 4 tables created")
    print()
    print("Expected tables:")
    print("- certificate_holders")
    print("- generated_certificates")
